                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>通知标题</label>
                                        <input id="gname" name="gname" class="form-control"
                                               placeholder="通知标题">
                                    </div>
                                   <div class="form-group col-md-6">
                                       <label>通知类型</label>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        function initializationLxtypesSelect(){
            ...
            if(lxTypesSelect != null && lxTypesOptions != null  && lxTypesOptions.length > 0 ){
        ...
        if(lxTypesSelect != null && lxTypesOptions != null  && lxTypesOptions.length > 0 ) {
            for (var i = 0; i < lxTypesOptions.length; i++) {
                if (lxTypesOptions[i].codeIndex == ruleForm.lxTypes) {//下拉框value对比,如果一致就赋值汉字
                        lxTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    function setContent() {
        ...
        <!-- 当前表的填充富文本框 -->
        if (ruleForm.tongzhiContent != null && ruleForm.tongzhiContent != 'null' && ruleForm.tongzhiContent != '') {

            var tongzhiContentUeditor = UE.getEditor('tongzhiContentEditor');
            tongzhiContentUeditor.ready(function () {
                var mes = '' + ruleForm.tongzhiContent;
    ...
    function getContent() {
        ...
        if (tongzhiContentEditor.hasContents()) {
                $('#tongzhiContent-input').attr('value', tongzhiContentEditor.getPlainTxt());
        }
    }
    //数字检查
        <!-- 当前表的数字检查 -->
