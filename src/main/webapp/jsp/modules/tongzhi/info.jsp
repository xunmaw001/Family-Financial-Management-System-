            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">通知登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="gname" name="gname" class="form-control"
                                               v-model="ruleForm.gname" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>通知类型</label>
                                    <input id="lxValue" name="lxValue" class="form-control"
                                           v-model="ruleForm.lxValue" readonly>
                                </div>
        ...
        if (ruleForm.tongzhiContent != null && ruleForm.tongzhiContent != 'null' && ruleForm.tongzhiContent != '') {
            var tongzhiContentUeditor = UE.getEditor('tongzhiContentEditor');
                tongzhiContentUeditor.ready(function () {
                    ...
                    tongzhiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
