    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">家庭账本管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">家庭账本管理</li>
                        <li class="breadcrumb-item active">家庭账本列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">家庭账本列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                                                 
                                        <label>
                                            收入支出名称
                                            <input type="text" id="zbnameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="收入支出名称" aria-controls="tableId">
                                        </label>
                                        ...
                                        <label>
                                            ...
                                            <label>
                                                ...
                                                <input type="text" id="nameSearch"  style="width: 120px;" class="form-control form-control-sm"
                                                       placeholder="消费人名称" aria-controls="tableId">
                                            </label>

                                <button onclick="search()" type="button" class="btn btn-primary">查询</button>
                                <button onclick="add()" type="button" class="btn btn-success 新增">添加</button>
                                <button onclick="graph('leixing_types','expense','jiatingzhangben')" type="button" class="btn btn-success 报表">报表</button>
...
<script>
    ...
    function search() {
        ...
        //收入支出名称
        var zbnameSearchInput = $('#zbnameSearch');
        if( zbnameSearchInput != null){
            if (zbnameSearchInput.val() != null && zbnameSearchInput.val() != '') {
                searchForm.zbname = $('#zbnameSearch').val();
            }
        }
    ...
    function getDataList() {
        http("jiatingzhangben/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
            //本表的
            zbname: searchForm.zbname,
    ...
    function setDataRow(item, number) {
        ...
        //家庭名称
        var jtTypesCell = document.createElement('td');
        jtTypesCell.innerHTML = item.jtValue;
        row.appendChild(jtTypesCell);


        //收入支出名称
        var zbnameCell = document.createElement('td');
        zbnameCell.innerHTML = item.zbname;
        row.appendChild(zbnameCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("jiatingzhangben/delete", "POST", paramArray, (res) => {
                if(res.code == 0){
                    getDataList();
                    alert('删除成功');
                }
    ...
    //添加
    function add() {
        window.sessionStorage.setItem("addjiatingzhangben", "addjiatingzhangben");
        window.location.href = "add-or-update.jsp"
    }

    //报表
    function graph(name,total,table1) {
        window.location.href = "graph1.jsp"
        //要展示的字段
        window.sessionStorage.setItem('name', name)
        //要统计的字段
        window.sessionStorage.setItem('total', total)
        //要关联的表
        window.sessionStorage.setItem('table1', table1)
    }
